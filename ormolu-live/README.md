...
Hence, Ormolu Live consists of two parts:
 ...
 - A regular Purescript frontend that displays input/output and manages options.
 - A background web worker that formats Haskell source code via the WASM-compiled Ormolu.
...
```
and then iterate by running sth like
```console
